...
for i in $(seq 1 $MAX); do
    ...
    # Output here is disabled, because when doing thousands of files it
    # actually slows down the process. You can re-enable them if you like:
    #echo "Item: $ITEMID"
    #mkdir -v "$DIR_OUT/$ITEMID"
