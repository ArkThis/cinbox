...
<span style="color:red"><big>⚠</big></span>   Add repository checkout information. 
...
📥 Inbox 
    ┗ 📂 todo
          ┗ 📂 ABC-123
                 ┠ 📂 hires
                 ┃      ┗ 📄 ABC-123.wav     ⇒  /mnt/archive/ABC-123/ABC-123.wav
                 ┠ 📂 lowres
                 ┃      ┗ 📄 ABC-123.mp3     ⇒  /mnt/cache/ABC-123.mp3
                 ┗ 📂 metadata
                         ┠ 📄 ABC-123.xml     ⇒  /mnt/archive/metadata/ABC-123.xml
                         ┗ 📄 checksums.md5   ⇒  /mnt/archive/metadata/checksums.md5
```
...
```
  📥 inbox
       ┗ 📂 ID-123                         
             ┗ 📁 hires                    
                    ┗ 📄 ABC-123.wav        ⇒        /mnt/archive/ID-123/hires_audio/id-123.wav                
